return {
  ...
  },
  {
    ...
    priority = 1000,
    conjig = function()
      vim.g.zenbones = { transparent_background = true, darken_comments = 45, darkness = 'warm' }
    end,
  },
        ...
        highlight_overrides = {
          all = function(colors)
            return {
              ...
              BlinkCmpLabelDescription = { fg = colors.subtext1 },
              BlinkCmpKind = { fg = colors.peach },
              ...
              SnacksPickerPreviewBorder = { fg = colors.base },
              SnacksPickerPreviewTitle = { fg = colors.base },
              SnacksPickerBoxBorder = { fg = colors.base },
              SnacksPickerInputBorder = { fg = colors.surface2 },
              SnacksPickerInputSearch = { fg = colors.text },
              -- SnacksPickerList = { bg = colors.base },
              SnacksPickerListBorder = { fg = colors.base },
              SnacksPickerListTitle = { fg = colors.base },
